...
| SHA256 | `1d14206484ba19f4d11215eb0f29d4d3b83e17adeacd1c0446ce68072408a22a` |
...
| **状态自适应首页** | 四种状态（未盘点/可挑模板/实验中/该复盘）各显示对应主卡，实验中含今日建议 |
| **复盘后去向** | 结论后出现下一步：继续→挑进阶模板；换方式→一键同模板续轮（标题自动标轮次）；排除→换方向 |
| **模板库** | /templates 显示 13 个模板；从模板创建后详情页显示随天数切换的「今日建议」 |
